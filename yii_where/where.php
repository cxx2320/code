...
class QueryBuilder
{
    ...
    {
        return 'ALTER TABLE ' . $this->quoteTableName($table)
            . ' RENAME COLUMN ' . $this->quoteColumnName($oldName)
    ...
    {
        return 'COMMENT ON TABLE ' . $this->quoteTableName($table) . ' IS ' . $this->db->quoteValue($comment);
    }
    ...
    {
        return 'COMMENT ON COLUMN ' . $this->quoteTableName($table) . '.' . $this->quoteColumnName($column) . ' IS NULL';
    }
    ...
    {
        return 'COMMENT ON TABLE ' . $this->quoteTableName($table) . ' IS NULL';
    }
